(function () {
    ...
    const menuCategories = [
        ...
        },
        {
            ...
            items: [
                ...
                { icon: "fa-volleyball", label: "Handball Ground", id: "menu-gsv-football1" },
    ...
    items.forEach((item) => {
        item.addEventListener("click", () => {
            ...
            // Handle URLs (Hub vs External)
            if (item.dataset.url) {
                if (item.id === "menu-home" || item.dataset.url.includes("index.html")) {
