/**
 * Mount Zion 360° Virtual Campus - Smart PWA Install Prompt (Matriculation Tour)
 */
(function () {
  'use strict';
      ...
      <div class="mz-pwa-banner" role="dialog" aria-label="Install Mount Zion App">
        <div class="mz-pwa-header">
          <div class="mz-pwa-icon-box">
            <img src="${iconSrc}" alt="Mount Zion Matriculation Logo" onerror="this.onerror=null;this.src='../dist/Logo1.png'">
          </div>
          <div class="mz-pwa-info">
            <div class="mz-pwa-title-row">
              <h3 class="mz-pwa-title">Mount Zion Matriculation</h3>
